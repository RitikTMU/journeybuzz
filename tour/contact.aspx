						...
						<form id="form3" runat="server"> 
							<div class="row form-group">
								...
								<div class="col-md-6">
									...
									<asp:TextBox ID="txtlastname"  CssClass="form-control"  placeholder="Name" runat="server"></asp:TextBox>
								</div>
							</div>
							...
							<div class="row form-group">
							 ...
							 <asp:TextBox ID="txtmail" CssClass="form-control" placeholder="Email" runat="server" TextMode="Email"></asp:TextBox>
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<asp:TextBox ID="txtmessage" CssClass="form-control" placeholder="Message..." runat="server" TextMode="MultiLine"></asp:TextBox>
								</div>
							</div>
